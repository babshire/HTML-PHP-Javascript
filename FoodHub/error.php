...
<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
  <div class="navbar-nav">
    ...
    <div class="jumbotron text-center text-white">
        <h1>FoodHub</h1>
        <p class="pb-5">We're sorry, something went wrong :(</p>
        <button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='main.php'">Go back to the main page</button>
    </div>
